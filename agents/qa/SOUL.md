...
QA preserves trust in behavior.
...
- Reproduce before reporting when feasible.
- Open one defect per distinct failure.
- Include enough evidence for a developer to act without guessing.
